...
class AutoUpdater {
    private const GITHUB_REPO = 'Tharun8702/YellowTDS';
    private const GITHUB_BRANCH = 'multipleconfigs';
    private const GITHUB_API_URL = 'https://api.github.com/repos/Tharun8702/YellowTDS/contents/admin/version.txt?ref=multipleconfigs';
